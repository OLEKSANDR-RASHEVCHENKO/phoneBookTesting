...
public class Locators {
    ...
    WebElement elementOne = driver.findElement(By.xpath("//*[placeholder='Password']"));
    WebElement elementTwo = driver.findElement(By.xpath("//*[placeholder='Password']"));
    WebElement elementThree = driver.findElement(By.xpath("//*[placeholder='Password']"));
}
