...
public class AddEmailDialog extends EmailPage {
    ...
    public void setEmailField (String emailField){
        ...
        setInput(openAddContactDialog().lastNameInput, emailField);
    }


    public void setLastNameInput(String lastName){

        setInput(openAddContactDialog().lastNameInput, lastName);
    }

    public void setDescription(String description){

        setInput(openAddContactDialog().descriptionInput, description);
    }
