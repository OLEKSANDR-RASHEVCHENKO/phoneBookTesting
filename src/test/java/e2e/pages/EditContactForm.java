...
public class EditContactForm extende ContactInfoPage{
    ...
    @FindBy(xpath = "//button@class='btn-primary submit-btn-ec']")
    ...
    public void saveChanges() throw InterruptedException {
